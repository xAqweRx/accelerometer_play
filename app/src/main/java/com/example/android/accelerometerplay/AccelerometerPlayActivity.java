...
public class AccelerometerPlayActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mSimulationView.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));

		findViewById(R.id.minus).setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				mSimulationView.decreaseParticle();
			}
		});
		...
		findViewById(R.id.plus).setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				mSimulationView.increaseParticle();
			}
		});
		((ViewGroup) findViewById(R.id.container)).addView(mSimulationView);
	}
	...
	class SimulationView extends FrameLayout implements SensorEventListener {
		...
		class ParticleSystem {
			...
			ParticleSystem() {
				...
				for (int i = 0; i < mBalls.size(); i++) {
					...
					mBalls.add(i, item);
					addView(item, new ViewGroup.LayoutParams(mDstWidth, mDstHeight));
				}
			}
			...
			private void decreaseParticle() {
				Particle item = mBalls.get(mBalls.size() - 1);
				mBalls.remove(item);
				removeView(item);
			}
		...
		protected void onDraw(Canvas canvas) {
			...
			for (int i = 0; i < count; i++) {
				...
				particleSystem.mBalls.get(i).setTranslationX(x);
				particleSystem.mBalls.get(i).setTranslationY(y);
			}
		...
		public void increaseParticle() {
			mParticleSystem.increaseParticle();
			invalidate();
		}

		public void decreaseParticle(){
			mParticleSystem.decreaseParticle();
			invalidate();
		}
